...
@pytest.fixture
async def client(test_app, mock_proxy_service):
    """Create test client with mocked proxy service"""
    # Override the dependency
    async def override_get_proxy_service():
...
class TestProxyAPI:
    ...
    @pytest.mark.asyncio
    async def test_execute_tool_success(self, client, mock_proxy_service):
    ...
    @pytest.mark.asyncio
    async def test_execute_tool_validation_error(self, client):
    ...
    @pytest.mark.asyncio
    async def test_execute_tool_not_provisioned(self, client, mock_proxy_service):
    ...
    @pytest.mark.asyncio
    async def test_execute_tool_server_error(self, client, mock_proxy_service):
    ...
    @pytest.mark.asyncio
    async def test_execute_tool_empty_arguments(self, client, mock_proxy_service):
    ...
    @pytest.mark.asyncio
    async def test_execute_tool_complex_arguments(self, client, mock_proxy_service):
    ...
    @pytest.mark.asyncio
    async def test_get_proxy_service_not_initialized(self, test_app):
